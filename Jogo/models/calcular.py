...
class Calcular:
    ...
    def __init__(self: object, dificuldade: int, /) -> None:
        ...
        self.__operacao: int = randint(1, 3) # valor varia de 1 a 3, 1 = somar, 2 = subtrair, 3 = multiplicar
    ...
    def _gerar_valor(self: object) -> int:
        if self.dificuldade == 1:
            ...
            print('Dificuldade desconhecida, então toma!')
    ...
    def _gerar_resultado(self: object) -> int:
        if self.operacao == 1:  # somar
            ...
            return self.valor1 * self.valor2  # multiplicação dos valores
